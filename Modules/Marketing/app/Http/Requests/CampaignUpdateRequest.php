...
class CampaignUpdateRequest extends FormRequest
{
    ...
    {
        return $this->user()->hasPermissionTo('marketing.campaigns.update') || $this->user()->isSuperAdmin();
    }
    ...
    public function validated($key = null, $default = null): array
    {
        ...
        $numericFields = [
            ...
            'actual_spend', 'actual_roi', 'actual_leads', 'actual_conversions',
            'actual_conversion_rate', 'actual_reach', 'actual_impressions',
            'actual_clicks', 'actual_ctr', 'actual_revenue',
        ];
    ...
    public function rules(): array
    {
        return [
            ...
            'actual_roi' => ['nullable', 'numeric'],
            'actual_leads' => ['nullable', 'integer', 'min:0'],
            'actual_conversions' => ['nullable', 'integer', 'min:0'],
            'actual_conversion_rate' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'actual_reach' => ['nullable', 'integer', 'min:0'],
            'actual_impressions' => ['nullable', 'integer', 'min:0'],
            'actual_clicks' => ['nullable', 'integer', 'min:0'],
            'actual_ctr' => ['nullable', 'numeric', 'min:0', 'max:100'],
    ...
    public function messages(): array
    {
        return [
            ...
            'campaign_status_id.exists' => 'Selected campaign status is invalid.',
            'campaign_channel_id.required' => 'Campaign channel is required.',
            'campaign_channel_id.exists' => 'Selected campaign channel is invalid.',
            ...
            'expected_leads.integer' => 'Expected leads must be a whole number.',
            'expected_leads.min' => 'Expected leads must be at least 0.',
        ];
    }
}
