...
interface LeadSourcesEditProps {
    leadSource: LeadSource;
    companies?: Company[];
}

export default function LeadSourcesEdit({ leadSource, companies }: LeadSourcesEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        company_id: leadSource.company_id?.toString() || '',
        name: leadSource.name || '',
        slug: leadSource.slug || '',
        description: leadSource.description || '',
        active: leadSource.active ?? true,
    });
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Updating...' : 'Update Lead Source'}
                        </Button>
                    </div>
                </form>
            </div>
