...
export default function DriverStagesCreate({ drivers, ridingCompanies }: DriverStagesCreateProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/drivers/driver-stages');
    };

    return (
        <AppLayout>
            <Head title="Create Driver Stage" />

            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold">Create Driver Stage</h1>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">
                        Add a new stage for a driver
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Creating...' : 'Create Driver Stage'}
                        </Button>
                    </div>
                </form>
            </div>
