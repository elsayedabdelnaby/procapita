...
export default function DocumentRequirementsEdit({ company, requirement }: DocumentRequirementsEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        default_status: requirement.default_status || 'pending',
    });

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/core/document-requirements/${requirement.id}`);
    };

    return (
        <AppLayout>
            <Head title={`Edit Document Requirement - ${requirement.name}`} />
            ...
            <div className="p-6">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">
                        Reseller: <strong>{company.name}</strong>
                    </p>
                </div>
