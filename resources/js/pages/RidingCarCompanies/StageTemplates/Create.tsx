...
interface StageTemplatesCreateProps {
    ridingCompany: RidingCompany;
}

export default function StageTemplatesCreate({ ridingCompany }: StageTemplatesCreateProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/ridingcarcompanies/riding-companies/${ridingCompany.id}/stage-templates`);
    };

    return (
        <AppLayout>
            <Head title={`Create Stage Template - ${ridingCompany.name}`} />

            <div className="p-6">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold">Create Stage Template</h1>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">
                        Add a new stage template for <strong>{ridingCompany.name}</strong>
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="md:col-span-2">
                                <FormField
                                    ...
                                    error={errors.name}
                                    required
                                    placeholder="e.g., Stage 1, Beginner Level"
                                />
                            </div>
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Creating...' : 'Create Stage Template'}
                        </Button>
                    </div>
                </form>
            </div>
